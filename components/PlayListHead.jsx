        ...
        <div className='flex flex-row gap-[50px]'>
            ...
            <article className='flex flex-col justify-center'>
                ...
                <ul className='hidden lg:flex flex-row gap-4 mt-4'>
                    ...
                    <WhiteButton className={'w-[85px] text-[14px]'} icon={<FiPlay />} label='재생' onClick={onClickPlayList}/>
                    <DarkButton className={'w-[140px] text-[14px]'} icon={<FiFolderPlus />} label={'보관함에 저장'}/>
                    <IconButton icon={<FiMoreVertical size={24} />} />
                </ul>
            </article>
        </div>
